...
/**
 * (package-private)<br>
 * Parses the response to a Get Data (FCP) command.
 *
 * @since 2.0
 ...
 */
final class CardGetDataFcpParser extends AbstractCardResponseParser {
  ...
  /**
   * Instantiates a new CardGetDataFcpParser.
   *
   * @param response the response from the card.
   * @param builder the reference to the builder that created this parser.
   * @since 2.0
   */
  public CardGetDataFcpParser(ApduResponseApi response, CardGetDataFcpBuilder builder) {
