 ...
 * @since 2.0.1
 */
final class CmdCardSvUndebit extends AbstractCardCommand {
   ...
   * @since 2.0.1
   */
  CmdCardSvUndebit(CalypsoCard calypsoCard, int amount, byte kvc, byte[] date, byte[] time) {
   ...
   * @since 2.0.1
   */
  void finalizeCommand(byte[] undebitComplementaryData) {
   ...
   */
  @Override
  CmdCardSvUndebit setApduResponse(ApduResponseApi apduResponse) {
  ...
  /**
   * {@inheritDoc} Gets the SV signature. <br>
