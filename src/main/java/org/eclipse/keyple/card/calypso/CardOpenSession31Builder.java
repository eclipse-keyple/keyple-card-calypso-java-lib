...
/**
 * (package-private)<br>
 * Builds the Open Session command for a card revision 3.1.
 *
 * @since 2.0
 */
final class CardOpenSession31Builder
    extends AbstractCardOpenSessionBuilder<AbstractCardOpenSessionParser> {

  private static final Logger logger = LoggerFactory.getLogger(CardOpenSession31Builder.class);
   ...
   * @since 2.0
   */
  public CardOpenSession31Builder(byte keyIndex, byte[] samChallenge, int sfi, int recordNumber) {
    super(CardRevision.REV3_1);
    ...
    setApduRequest(
        new ApduRequestAdapter(
            ApduUtil.build(
                ...
                CalypsoCardCommand.getOpenSessionForRev(CardRevision.REV3_1).getInstructionByte(),
                p1,
                p2,
                samChallenge,
                le)));
   ...
   */
  @Override
  public CardOpenSession31Parser createResponseParser(ApduResponseApi apduResponse) {
    return new CardOpenSession31Parser(apduResponse, this);
  }
