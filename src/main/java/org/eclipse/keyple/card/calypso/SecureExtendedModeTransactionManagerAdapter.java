...
final class SecureExtendedModeTransactionManagerAdapter
  ...
  private static final String MSG_MSS_COMMAND_NOT_SUPPORTED =
      "'Manage Secure Session' command is not available for this context (Card and/or SAM does not support extended mode)";
  private static final String MSG_ENCRYPTION_ALREADY_ACTIVE = "Encryption is already active";
  private static final String MSG_ENCRYPTION_NOT_ACTIVE = "Encryption is not active";
