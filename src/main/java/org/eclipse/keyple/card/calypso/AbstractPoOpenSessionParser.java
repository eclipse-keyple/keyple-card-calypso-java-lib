 ...
 * @since 2.0
 */
abstract class AbstractPoOpenSessionParser extends AbstractPoResponseParser {
  ...
  /**
   * Instantiates a new AbstractPoOpenSessionParser.
   *
  ...
  public AbstractPoOpenSessionParser create(ApduResponse response, PoRevision revision) {
    switch (revision) {
      ...
      case REV2_4:
        return new PoOpenSession24Parser(response, (PoOpenSession24Builder) builder);
      case REV3_1:
      case REV3_1_CLAP:
        return new PoOpenSession31Parser(response, (PoOpenSession31Builder) builder);
      case REV3_2:
        return new PoOpenSession32Parser(response, (PoOpenSession32Builder) builder);
      default:
