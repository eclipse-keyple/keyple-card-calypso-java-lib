...
final class SamGiveRandomBuilder extends AbstractSamCommandBuilder<SamGiveRandomParser> {
  ...
  public SamGiveRandomBuilder(SamRevision revision, byte[] random) {
    ...
    setApduRequest(
        new ApduRequest(ApduUtil.build(cla, command.getInstructionByte(), p1, p2, random, null)));
  }
   ...
   */
  @Override
  public SamGiveRandomParser createResponseParser(ApduResponse apduResponse) {
