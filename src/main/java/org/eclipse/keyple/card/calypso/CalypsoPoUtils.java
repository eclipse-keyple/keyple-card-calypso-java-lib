...
final class CalypsoPoUtils {
   ...
   * CalypsoCard.
   *
   * @param calypsoPoSmartCard the {@link CalypsoCardAdapter} object to update.
  ...
  private static AbstractPoOpenSessionParser updateCalypsoPoOpenSession(
      CalypsoCardAdapter calypsoPoSmartCard,
  ...
  /**
   * (package-private)<br>
   * Fills the CalypsoCard with the PO's response to a single command
   *
   * @param calypsoPoSmartCard the {@link CalypsoCardAdapter} object to fill with the. provided
  ...
  /**
   * (package-private)<br>
   * Fills the CalypsoCard with the PO's responses to a list of commands
   *
   * @param calypsoPoSmartCard the {@link CalypsoCardAdapter} object to fill with the. provided
   *     response from the PO
