...
final class PoWriteRecordBuilder extends AbstractPoCommandBuilder<PoWriteRecordParser> {
  ...
  /**
   * Instantiates a new PoWriteRecordBuilder.
   *
   ...
   * @since 2.0
   */
  public PoWriteRecordBuilder(PoClass poClass, byte sfi, int recordNumber, byte[] newRecordData) {
    super(command, null);
   ...
   */
  @Override
  public PoWriteRecordParser createResponseParser(ApduResponse apduResponse) {
    return new PoWriteRecordParser(apduResponse, this);
  }
