 ...
 * @since 2.0
 */
public class CalypsoCardSelector extends CardSelector {

  private static final int SW_PO_INVALIDATED = 0x6283;

  private CalypsoCardSelector() {}
   ...
   * @since 2.0
   */
  public CalypsoCardSelector acceptInvalidatedPo(InvalidatedPo invalidatedPo) {
