 ...
 * @since 2.0
 */
final class PoGetDataTraceParser extends AbstractPoResponseParser {
  ...
  /**
   * Instantiates a new PoGetDataTraceParser from the ApduResponse to a selection application
   * command.
   *
   ...
   * @since 2.0
   */
  public PoGetDataTraceParser(ApduResponse response, PoGetDataTraceBuilder builder) {
