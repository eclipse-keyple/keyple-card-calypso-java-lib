 ...
 * @since 2.0
 */
final class SamDigestAuthenticateParser extends AbstractSamResponseParser {
   ...
   * @since 2.0
   */
  public SamDigestAuthenticateParser(ApduResponse response, SamDigestAuthenticateBuilder builder) {
