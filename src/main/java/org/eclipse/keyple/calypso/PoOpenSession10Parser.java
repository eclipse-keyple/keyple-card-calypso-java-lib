 ...
 * @since 2.0
 */
final class PoOpenSession10Parser extends AbstractPoOpenSessionParser {

  /**
   * Instantiates a new PoOpenSession10Parser from the response.
   *
   * @param response from PoOpenSession10Parser.
