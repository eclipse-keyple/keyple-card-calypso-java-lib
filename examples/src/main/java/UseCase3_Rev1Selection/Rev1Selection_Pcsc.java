 ...
 ************************************************************************************** */
package UseCase3_Rev1Selection;
...
public class Rev1Selection_Pcsc {
  ...
  public static void main(String[] args) {
    ...
    cardExtension
        ...
        .prepareReadRecordFile(CalypsoDef.SFI_EVENT_LOG, 1)
    ...
    logger.info(
        "File {}h, rec 1: FILE_CONTENT = {}",
        String.format("%02X", CalypsoDef.SFI_EVENT_LOG),
        calypsoCard.getFileBySfi(CalypsoDef.SFI_EVENT_LOG));
