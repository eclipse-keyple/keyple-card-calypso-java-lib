...
dependencies {
    ...
    implementation("org.calypsonet.terminal:calypsonet-terminal-calypso-java-api:1.0-rc1")
    ...
    implementation("org.eclipse.keyple:keyple-plugin-pcsc-java-lib:2.0.0-rc2")
    implementation("org.eclipse.keyple:keyple-util-java-lib:2.0.0-rc1")
    implementation("org.eclipse.keyple:keyple-card-calypso-java-lib:2.0.0-rc2")
